                  ...
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="fullName"
                        id="fullName"
                        placeholder="Lazher Btr"
                        defaultValue="Lazher Btr"
                      />
                    </div>
                  </div>
                  ...
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="phoneNumber"
                        id="phoneNumber"
                        placeholder="+971 521470092"
                        defaultValue="+971 521470092"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-5.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      name="emailAddress"
                      id="emailAddress"
                      placeholder="lazher.btr@gmail.com"
                      defaultValue="lazher.btr@gmail.com"
                    />
                  </div>
                </div>
                ...
                <div className="mb-5.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      name="Username"
                      id="Username"
                      placeholder="lazherbtra07"
                      defaultValue="lazherbtra07"
                    />
                  </div>
                </div>
                ...
                <div className="mb-5.5">
                  ...
                  <div className="relative">
                    ...
                    <textarea
                      ...
                      defaultValue="In my role as a UI Designer and Web Developer,i working closely with cross-functional teams to translate design concepts into functional code. Whether it's designing user interfaces, implementing frontend components, or optimizing website performance, I am committed to delivering high-quality solutions that exceed expectations and drive business results."
                    ></textarea>
                  </div>
                </div>
